...
def show_groups(students_info):
    ...
    print("\nСписок груп та студентів у них:")
    for group, students in groups.items():
        print(f"\nГрупа {group}:")
        for student in students:
            print(f" - {student}")
            #Додав Давиденко Федір
...
def menu():
    while True:
        ...
        print("7 - Переглянути студентів за групами")#Додав Давиденко Федір
        ...
        if choice == "1":
            ...
            show_groups(students_info)#Додав Давиденко Федір
        elif choice == "0":
